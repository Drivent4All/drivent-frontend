...
import { HotelsRoom } from './HotelRoomsChange';
...
export const HotelComponent = ({ setBooking, bookingId, setChangeRoom }) => {
    ...
    <Hotels>
      ...
      {selectedHotel ?
        <>
          ...
          {selectedHotel ?
            <HotelsRoom hotel={selectedHotel} setBooking={setBooking} bookingId={bookingId} setChangeRoom={setChangeRoom}/>
            :
            <></>
          }
        </> 
